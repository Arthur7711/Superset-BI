        ...
        [
          {
            ...
            config: {
              ...
              description: t('Metrics to display. Multiple metrics create a panel view.'),
            },
          },
        ],
        ['adhoc_filters'],
        ...
        [
          {
            ...
            config: {
              ...
              step: 2,
              default: 36,
              description: t('Maximum font size for the big number (auto-scaled to fit)'),
            },
          },
        ],
        [
          {
            ...
            config: {
              ...
              renderTrigger: true,
              description: t('D3 format string for numbers (e.g., ".1%", "$,.0f")'),
              default: '',
            },
          },
        ],
        [
          {
            ...
            config: {
              ...
              default: 3,
              description: t('Number of columns when displaying multiple metrics'),
            },
          },
        ],
      ],
        ...
        [
          ...
          },
          {
            ...
            config: {
              ...
              default: false,
              visibility: ({ controls }: ControlPanelsContainerProps) =>
                controls?.showGoal?.value === true && controls?.showGoalProgress?.value === true,
            },
          },
        ],
        [
          {
            ...
            config: {
              ...
              renderTrigger: true,
              description: t('Color values based on thresholds (alternative to goal-based coloring)'),
              default: false,
              visibility: ({ controls }: ControlPanelsContainerProps) =>
                controls?.showGoal?.value !== true,
            },
        ...
        [
          {
            ...
            config: {
              ...
              renderTrigger: true,
              description: t('Two comma-separated values. E.g., "50,80" means: Red < 50 < Yellow < 80 < Green'),
              default: '50,80',
              visibility: ({ controls }: ControlPanelsContainerProps) =>
                controls?.showGoal?.value !== true && controls?.useColorLegend?.value === true,
            },
          },
        ],
        [
          {
            ...
            config: {
              ...
              renderTrigger: true,
              description: t('Smooth gradient between colors instead of discrete bands'),
              default: false,
              visibility: ({ controls }: ControlPanelsContainerProps) =>
                (controls?.showGoal?.value === true) || (controls?.useColorLegend?.value === true),
            },
        ...
        [
          {
            ...
            config: {
              ...
              renderTrigger: true,
              description: t('Show colored dot when value is in warning/danger zone'),
              default: true,
            },
          },
        ],
        ...
        [
          {
            ...
            config: {
              ...
              renderTrigger: false,
              description: t('Format: "1:MoM,12:YoY" or "1,12". Compares against N periods ago.'),
              default: '1:MoM',
              visibility: ({ controls }: ControlPanelsContainerProps) =>
        ...
        [
          {
            ...
            config: {
              ...
              renderTrigger: true,
              description: t('Only color the current value (useful for seasonal comparison)'),
              default: false,
            },
          },
        ],
