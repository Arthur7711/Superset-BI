...
// const { logAxis, minorSplitLine, truncateYAxis, yAxisBounds, zoomable } =
//   DEFAULT_FORM_DATA;

// function createAxisTitleControl(): ControlSetRow[] {
...
//           renderTrigger: true,
//           description: t(
//             'It’s not recommended to truncate axis in MixedBar chart.',
//           ),
//           visibility: () => !isVertical,
//           disableStash: true,
//           resetOnHide: false,
